...
public class Lab11 {
    public static void main(String[] args) {
        ...
        employees.add(new Employee("Tim", "Johnson", 0, 1));
        employees.add(new Employee("Joe", "Darnelle", 1, 4));
        employees.add(new Employee("John", "Daniels", 2, 2));
        employees.add(new Employee("Roger", "Smith", 3, 7));
        employees.add(new Employee("Richard", "Carlson", 4, 2));
        employees.add(new Employee("Corey", "Lambdon", 5, 9));
        employees.add(new Employee("Ian", "Bronson", 6, 3));
        employees.add(new Employee("Taylor", "Johnson", 7, 2));
        employees.add(new Employee("Stephanie", "Roberts", 8, 5));
        employees.add(new Employee("Helen", "Williams", 9, 6));
        ...
        employees.stream().limit(5).forEach(e -> System.out.println(e.toString()));
    ...
    /*see if any employee has a employee number 1 */
      ...
      /*Step 4. Similar to thea anyMatch above, see if all employees have an employee number of 1.*/
        ...
        System.out.println(employees.stream().allMatch(e -> e.getAccessCode() == 1));
        ...
        System.out.println(employees.stream().noneMatch(e -> e.getAccessCode() == 1));
        ...
        List<Employee> filter3 = new ArrayList<>();
        List<Employee> filter4 = new ArrayList<>();
